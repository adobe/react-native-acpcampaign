...
build-sample-ios:
	(cd sample/ACP*Sample/ios && xcodebuild build -project ACPCampaignSample.xcodeproj -scheme ACPCampaignSample CODE_SIGN_IDENTITY="" CODE_SIGNING_REQUIRED="NO" CODE_SIGNING_ALLOWED="NO")
